...
dashboard.config(["$stateProvider", function ($stateProvider) {
  ...
  //Employee page state
    $stateProvider.state('app.timesheet', {
        url: '/timesheet',
        templateUrl: 'app/modules/dashboard/views/timeSheet.html',
        controller: 'EmployeeController',
        controllerAs: 'vm',
        data: {
            pageTitle: 'Timesheet'
  ...
  //Add Employee state
    $stateProvider.state('app.addEmp', {
        url: '/addEmployee',
        templateUrl: 'app/modules/dashboard/views/addEmployeeDetails.html',
        controller: 'addEmployeeCtrl',
        controllerAs: 'vm',
        data: {
            pageTitle: 'Add Employee Details'
        }
    });
    
  //Update Employee state
    $stateProvider.state('app.updateEmp', {
        url: '/updateEmployee',
        templateUrl: 'app/modules/dashboard/views/updateEmployeeDetails.html',
